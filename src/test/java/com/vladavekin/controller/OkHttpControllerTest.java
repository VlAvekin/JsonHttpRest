...
public class OkHttpControllerTest {

    private String url = "https://lb-api-sandbox.prozorro.gov.ua/api/2.4/contracts/23567e24f52746ef92c470be6059d193/documents";
    private String expectedValue = "{\"data\": " +
            "[{" +
    ...
    public void post() throws IOException {
        OkHttpController okhc = new OkHttpController();

        final String actualValue = okhc.post(url);
